...
export default function LaboratoryCard({ item }: LaboratoryCardProps) {
          ...
          {item.is_accessible && item.completion_rate > 0 && (
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xs font-bold text-blue-600">{Math.round(item.completion_rate * 100)}%</span>
              </div>
